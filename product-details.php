        ...
        <div class="item">
            <div class="products">
                <div class="hot-deal-wrapper">
                    <div class="image">
                        <img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage2']);?>"  
                ...
                <div class="product-info text-left m-t-20">
                    ...
                    <div class="product-price">    
                        ...
                        <span class="price-before-discount">
                            Rs. <?php echo htmlentities($rws['productPriceBeforeDiscount']);?>
                        </span>                  
                    </div><!-- /.product-price -->
                </div><!-- /.product-info -->
                    ...
                    <div class="action">
                        <div class="add-cart-button btn-group">
                            <?php if ($rws['stock'] > 0) { ?>
                                ...
                                <a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">
                                    Add to cart
                                </a>
                            <?php } else { ?>
                                <p style="color: red; font-weight: bold; padding: 10px;">Out of Stock</p>
                            <?php } ?>
                        </div>
                    </div><!-- /.action -->
                </div><!-- /.cart -->
            ...
            <div class="stock-box">
                <span class="value" 
                      style="font-weight: bold; 
                             color: <?php echo ($row['stock'] > 0) ? 'green' : 'red'; ?>;">
...
<div class="stock-container info-container m-t-10">
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="stock-box">
                <span class="value"><?php echo htmlentities($row['stock']); ?></span>
            </div>	
        </div>
    </div><!-- /.row -->	
</div>
...
<div class="quantity-container info-container">
    <div class="row">
        <?php if ($row['stock'] > 0) { ?>
            <!-- Show quantity and Add to Cart when in stock -->
            <div class="col-sm-2">
        ...
        <?php } else { ?>
            ...
            <div class="col-sm-12 text-center">
                <p style="color: red; font-weight: bold; font-size: 16px; margin-top: 10px;">
                    Item will be avaliable soon
                </p>
            </div>
        <?php } ?>
    </div><!-- /.row -->
